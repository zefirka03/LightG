...
VkResult VulkanSwapChain::submit_command_buffers(const VkCommandBuffer *buffers, uint32_t *imageIndex) {
...
VkSurfaceFormatKHR VulkanSwapChain::_choose_swap_surface_format(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
...
VkPresentModeKHR VulkanSwapChain::_choose_swap_present_mode(const std::vector<VkPresentModeKHR>& availablePresentModes) {
...
VkExtent2D VulkanSwapChain::_choose_swap_extent(const VkSurfaceCapabilitiesKHR& capabilities) {
...
void VulkanSwapChain::_create_swap_chain() {
...
void VulkanSwapChain::_create_image_views() {
...
void VulkanSwapChain::_create_render_pass() {
...
void VulkanSwapChain::_create_framebuffers() {
...
void VulkanSwapChain::_create_depth_resources() {
...
void VulkanSwapChain::_create_sync_objects() {
